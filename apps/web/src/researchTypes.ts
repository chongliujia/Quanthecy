...
export type Evidence = { id: string; revision_id: string; version: number; source_slug: string; source_name: string; title: string; excerpt: string; url: string; published_at: string | null; first_observed_at: string; observed_at: string; content_hash: string }
...
export type EvidenceDetail = { item: Evidence; revisions: Evidence[]; links: EvidenceLink[]; cutoff: string }
